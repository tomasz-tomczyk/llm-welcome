defmodule LlmWelcomeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LlmWelcomeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LlmWelcomeWeb.Gettext, "errors", msg, opts)
    end
  end
